...
;; Silence byte-compiler warnings for variables/functions defined in submodules
...
(declare-function tramp-rpc-handle-make-process "tramp-rpc-process")
(declare-function tramp-rpc-handle-start-file-process "tramp-rpc-process")
...
(declare-function tramp-rpc-projectile--advice-get-ext-command "tramp-rpc-magit")
(declare-function tramp-rpc-projectile--advice-dir-files "tramp-rpc-magit")
(declare-function tramp-rpc-projectile--advice-project-files "tramp-rpc-magit")
(declare-function tramp-rpc-magit--advice-setup-buffer "tramp-rpc-magit")
(declare-function tramp-rpc-magit--advice-refresh-buffer "tramp-rpc-magit")
...
;; Process support (async, PTY, make-process, start-file-process)
(require 'tramp-rpc-process)
;; Advice on built-in process functions (process-send-string, etc.)
(require 'tramp-rpc-advice)
;; Magit/projectile integration, caching, filesystem watching
