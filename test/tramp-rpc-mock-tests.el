...
(ert-deftest tramp-rpc-mock-test-deploy-existing-binary-must-be-regular ()
  "Remote deployment checks reject executable directories and special files."
  :tags '(:deploy)
  (skip-unless tramp-rpc-mock-test--tramp-rpc-loaded)
  (let (command)
